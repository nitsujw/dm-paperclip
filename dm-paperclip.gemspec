...
Gem::Specification.new do |s|
  ...
  s.files = ["README.rdoc", "LICENSE", "Rakefile", "init.rb", "lib/dm-paperclip.rb", "lib/dm-paperclip", "lib/dm-paperclip/interpolations.rb", "lib/dm-paperclip/callback_compatability.rb", "lib/dm-paperclip/attachment.rb", "lib/dm-paperclip/geometry.rb", "lib/dm-paperclip/upfile.rb", "lib/dm-paperclip/thumbnail.rb", "lib/dm-paperclip/storage.rb", "lib/dm-paperclip/iostream.rb", "lib/dm-paperclip/processor.rb", "lib/dm-paperclip/validations.rb", "tasks/paperclip_tasks.rake", "test/paperclip_test.rb", "test/storage_test.rb", "test/geometry_test.rb", "test/attachment_test.rb", "test/helper.rb", "test/thumbnail_test.rb", "test/fixtures", "test/fixtures/text.txt", "test/fixtures/s3.yml", "test/fixtures/50x50.png", "test/fixtures/12k.png", "test/fixtures/bad.png", "test/fixtures/5k.png", "test/integration_test.rb", "test/iostream_test.rb"]
