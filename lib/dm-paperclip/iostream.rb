...
module IOStream
	...
	# the whole thing into memory. Defaults to 8k blocks.  	Returns a file if string is passed in
	# as the destination and returns the IO or tempfile as passed in if one is sent as the destination
